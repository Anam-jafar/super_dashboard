                        ...
                        <div class="mb-4 border-b border-gray-200">
                            <ul class="flex flex-wrap -mb-px" role="tablist">
                                <li class="mr-2" role="presentation">
                                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="general-tab"
                                        onclick="changeTab(event, 'general')" type="button" role="tab"
                        ...
                        <div id="tabContent">
                            ...
                            <div id="general" class="tab-content">
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    <div>
                                        <label for="modalName"
                                            class="block text-sm font-medium text-gray-700">Centre/Program</label>
                                        <input type="text" id="modalName"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="modalSname"
                                            class="block text-sm font-medium text-gray-700">Singkatan</label>
                                        <input type="text" id="modalSname"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="modalSchcat"
                                            class="block text-sm font-medium text-gray-700">Kategori</label>
                                        <input type="text" id="modalSchcat"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="modalTel"
                                            class="block text-sm font-medium text-gray-700">Telefon</label>
                                        <input type="tel" id="modalTel"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="modalMel" class="block text-sm font-medium text-gray-700">Emel</label>
                                        <input type="email" id="modalMel"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div>
                                        <label for="modalUrl" class="block text-sm font-medium text-gray-700">Web</label>
                                        <input type="url" id="modalUrl"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <label for="modalCountry"
                                            class="block text-sm font-medium text-gray-700">Negara</label>
