                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="xxl:col-span-4 xl:col-span-6 col-span-12">
                            <div class="box overflow-hidden">
                                ...
                                <div class="box-body p-0 mt-4 mb-3">
                                    ...
                                    <ul class="list-none recent-activity-list">
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <span class="block text-textmuted dark:text-textmuted/50">
                                                    added a <span class="font-medium text-dark">new user</span> with
                                                    username <span
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <span class="block text-textmuted dark:text-textmuted/50">
                                                    added <span class="font-medium text-primarytint3color">John
                                                        Smith</span> to
                                        ...
                                        {{-- <li>
                                            <div>
                                                ...
                                                <span class="block text-textmuted dark:text-textmuted/50">
                                                    added a comment to the task <span
                                                        class="font-medium text-secondary">Update
                                                        website layout.</span>
                                                </span>
                                            </div>
                                        </li> --}}
                                ...
                                <div class="box-body p-6">
                                    <div class="grid grid-cols-12 justify-between">
                                        <div
                                            ...
                                            <h4 class="mb-4 font-medium text-white">Upgrade to get more</h4>
                                            <p class="mb-6 text-white">Maximize sales insights. Optimize performance.
                                                Achieve success with pro.</p>
                                            <a href="javascript:void(0);"
                                                class="font-medium text-white decoration-solid underline">Upgrade To Pro<i
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('build/assets/images/media/media-86.png') }}"
                                                alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body p-0">
                                    <div class="p-4 pb-0">
                                        ...
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <div class="h6 mb-0"><span class="text-success me-2 text-[11px]">2.74%<i
                                            ...
                                            <tbody>
                                                <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">25%
                                                            Gross</span>
                                                    </td>
                                                    <td class="!text-end">
                                                ...
                                                <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">16%
                                                            Gross</span>
                                                    </td>
                                                    <td class="!text-end">
                                                ...
                                                <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">22%
                                                            Gross</span>
                                                    </td>
                                                    <td class="!text-end">
                                                ...
                                                <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">18%
                                                            Gross</span>
                                                    </td>
                                                    <td class="!text-end">
                                                        <span class="badge bg-primarytint1color">1.14% <i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center border-b-0">
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">15%
                                                            Gross</span>
                                                    </td>
                                ...
                                <table class="ti-custom-table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr class="border !border-defaultborder dark:!border-defaultborder/10">
                                            ...
                                            <td>
                                                <div class="ti-btn-list">
                                                    <button class="ti-btn ti-btn-sm ti-btn-icon ti-btn-soft-success"><i
                                                            class="ri-pencil-line"></i></button>
                                                    <button class="ti-btn ti-btn-sm ti-btn-icon ti-btn-soft-danger"><i
                                        ...
                                        <tr class="border !border-defaultborder dark:!border-defaultborder/10">
                                            <td class="text-center">
                                                <input class="form-check-input" type="checkbox" id="checkboxNoLabel12"
                                                    value="" aria-label="...">
                                            </td>
                                            <td>
                                                <div class="flex items-center gap-4">
                                        ...
                                        <tr class="border !border-defaultborder dark:!border-defaultborder/10">
                                            <td class="text-center">
                                                <input class="form-check-input" type="checkbox" id="checkboxNoLabel42"
                                                    value="" aria-label="..." checked>
                                            </td>
                                            <td>
                                                <div class="flex items-center gap-4">
                                        ...
                                        <tr class="border !border-defaultborder dark:!border-defaultborder/10">
                                            <td class="text-center">
                                                <input class="form-check-input" type="checkbox" id="checkboxNoLabel32"
                                                    value="" aria-label="..." checked>
                                            </td>
                                            <td>
                                                <div class="flex items-center gap-4">
                            ...
                            <ul class="list-none sales-country-list">
                                <li>
                                    <div class="flex items-start gap-4">
                                        <div class="leading-none">
                                            <span
                                                class="avatar avatar-sm p-1 bg-light border dark:border-defaultborder/10">
                                ...
                                <li>
                                    <div class="flex items-start gap-4">
                                        <div class="leading-none">
                                            <span
                                                class="avatar avatar-sm p-1 bg-light border dark:border-defaultborder/10">
                                                <img src="{{ asset('build/assets/images/flags/italy_flag.jpg') }}"
                                                    alt="">
                                            </span>
                                        </div>
                                        <div class="flex-auto w-full">
                                ...
                                <li>
                                    <div class="flex items-start gap-4">
                                        <div class="leading-none">
                                            <span
                                                class="avatar avatar-sm p-1 bg-light border dark:border-defaultborder/10">
                                                <img src="{{ asset('build/assets/images/flags/china_flag.jpg') }}"
                                                    alt="">
                                            </span>
                                        </div>
                                        <div class="flex-auto w-full">
