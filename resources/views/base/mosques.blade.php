...
<!-- Modal -->
<div id="mosqueModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="mt-3">
            ...
            <div class="flex justify-between items-center pb-3">
                ...
                <div class="flex space-x-2">
                    ...
                    <button onclick="updateMosque()" class="px-3 py-1 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300">
                        Update
                    </button>
            ...
            <div class="mb-4 border-b border-gray-200">
                <ul class="flex flex-wrap -mb-px" role="tablist">
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 border-indigo-500 text-indigo-600 rounded-t-lg" 
                                id="profile-tab" 
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" 
                                id="address-tab" 
                                onclick="changeTab(event, 'address')" 
                                type="button" 
                                role="tab" 
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" 
                                id="additional-tab" 
                                onclick="changeTab(event, 'additional')" 
                                type="button" 
                                role="tab" 
