                         ...
                         <div class="max-w-sm mx-auto w-full">
                             ...
                             <form class="space-y-4" action="{{ route('submit.login') }}" method="POST">
                                 ...
                                 <div id="resetPasswordModal"
                                     ...
                                     <div
                                         class="bg-white rounded-xl shadow-lg p-8 w-full md:max-w-[60%] md:h-[70%] mx-auto text-center relative">
                                         <!-- Close Button -->
                                         <button type="button"
                                             onclick="document.getElementById('resetPasswordModal').style.display='none'"
                                         ...
                                         <!-- Email Input -->
                                         <div class="mb-8">
                                             <input type="email" placeholder="Masukkan Email" name="mel"
                                         ...
                                         <div class="flex justify-center">
                                             <button onclick="handleContinue()" type
                                 ...
                                 <div id="fillOtp"
                                     ...
                                     <div
                                         ...
                                         <!-- Close Button -->
                                         <button type="button"
                                             onclick="document.getElementById('fillOtp').style.display='none'"
                                             class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 text-xl">&times;</button>
