                        ...
                        <div class="w-full lg:w-1/2 mt-4 lg:mt-0">
                            <div class="bg-white shadow-lg rounded-lg p-6 h-full">
                                <div class="flex justify-between items-start mb-6">
                                    <h2 class="text-lg font-semibold text-gray-800">PERATUSAN JENIS MASJID SELURUH SELANGOR
                                    </h2>
                    ...
                    <div class="w-full mt-8">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-white shadow-lg rounded-lg p-6">
                                <h4 class="text-lg font-semibold text-gray-800 mb-4">Jumlah Ahli Kariah Mengikut Daerah
                                </h4>
                                            ...
                                            @foreach ($totalKariahPerDistrict as $district)
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="px-4 py-2 text-sm text-gray-500 text-right">
                                                        {{ number_format($district->total_kariah) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
